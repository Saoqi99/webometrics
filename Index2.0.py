...
#             year = bib.get('year', '')
#             if year:  # Jika tahun ada
#                 try:
#                     year = int(year)  # Coba konversi ke integer
#                 except (ValueError, TypeError):
#                     year = str(year).strip()  # Jika gagal, gunakan string asli
#             else:
#                 year = 'Tidak Diketahui'  # Default value
#
...
#                 'year': year,  # Gunakan year yang sudah di-handle
...
#     excluded_names = load_excluded_names("Kecuali7.xlsx")
#
